				...
				<div className="flex justify-between items-center flex-wrap max-w-7xl mx-auto w-full h-full text-gray-200">
					<div className="p-3 w-full h-full max-w-sm flex flex-col items-start">
						...
						<div className="flex items-center py-3 max-w-sm">
							<a href="https://www.facebook.com/MoksharOfficial" target="_blank" rel="noreferrer">
								<div className="p-3 border-2 border-gray-200 m-1">
									<svg xmlns="http://www.w3.org/2000/svg" className="fill-gray-200" viewBox="0 0 24 24" width="32px" height="32px">
						...
						<div className="flex items-center justify-center">
							<p className="text-sm">
								Built with
								<svg fill="red" className="w-5 h-5 inline-block " viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
