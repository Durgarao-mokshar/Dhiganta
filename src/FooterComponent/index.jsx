export default function FooterComponent() {
  return (
    <footer className="w-full h-full bg-green-800 overflow-hidden ">
        ...
        <div className="p-4 pt-16 max-w-7xl mx-auto w-full h-full flex justify-between items-start flex-wrap text-gray-200 ">
          ...
          <div className="flex justify-between w-full h-full max-w-lg py-4">
            ...
            <div className="">
              ...
              <p>
                plot 60A, sri lakshmi nilayam, Film Nagar Rd Number 12,
                Tarakarama Nagar, Film Nagar, Hyderabad, Telangana 500096
              </p>
            </div>
          </div>
        </div>
        <div className="flex justify-between items-center flex-wrap max-w-7xl mx-auto w-full h-full text-gray-200">
          <div className="p-3 w-full h-full max-w-sm flex flex-col items-start">
            <div className="text-xl font-semibold">Follow us on socials</div>
            {/* <div className="flex items-center py-3 max-w-sm">
              <a
                href="https://www.facebook.com/MoksharOfficial"
                target="_blank"
                rel="noreferrer"
              >
                <div className="p-3 border-2 border-gray-200 m-1">
                  <svg
              ...
              <a
                href="https://twitter.com/moksharofficial"
                target="_blank"
                rel="noreferrer"
              >
                <div className="p-3 border-2 border-gray-200 m-1">
              ...
              <a
                href="https://www.instagram.com/moksharofficial"
                target="_blank"
                rel="noreferrer"
              >
                <div className="p-3 border-2  border-gray-200 m-1">
              ...
              <a
                href="https://www.linkedin.com/company/moksharofficial/about/"
                target="_blank"
                rel="noreferrer"
              >
                <div className="p-3 border-2 border-gray-200 m-1">
