  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center w-full min-h-screen bg-gradient-to-r from-orange-200 to-gray-300">
        <div className="grid lg:grid-cols-2 lg:gap-32 md:grid-cols-2 md:gap-12 gap-6  max-w-7xl mx-auto px-4">
          <div className="flex flex-col gap-4 items-center justify-center font-playfair">
            <div className="capitalize font-bold lg:text-5xl md:text-4xl text-2xl text-gray-700">
              <Typewriter
                options={{
            ...
            <h1 className="text-lg  text-center mt-4 text-purple-900  font-serif">
              Embark on captivating journeys with Dhiganta as they skillfully
              craft visual narratives. Revealing the very soul of each story
            ...
            <div className=" transition-transform ease-in-out duration-500 hover:border-gray-100 hover:scale-110 text-black">
              <div className="group  relative cursor-pointer border border-gray-700  px-3 py-1  rounded-full transition ease-in-out duration-500 hover:border-gray-100 hover:scale-110">
                <div className="uppercase text-xl flex items-center relative font-mono text-slate-800">
